...
val elem : string -> attr list -> t list -> t
...
val resource : init:(unit -> 'resource) -> free:('resource -> unit) -> ('resource -> t) -> t

(** {2 DOM helpers} *)

val mount : Dom.node -> t -> unit
